...
Refresh.Web.DefaultColorPickerSettings = {
	startMode:'h',
	startHex:'ff0000',
	clientFilesPath: 'colorpicker/colorpicker/images/'
};
...
Refresh.Web.ColorPicker.prototype = {
	...
	initialize: function(id, settings) {
		...
		// attach map slider
		this._map = new Refresh.Web.Slider(this._mapL2, {id:"map" ,xMaxValue: 255, yMinValue: 255, arrowImage: this.settings.clientFilesPath + 'mappoint.gif'});

		// attach color slider
		this._slider = new Refresh.Web.Slider(this._barL4, {id:"slider",xMinValue: 1,xMaxValue: 1, yMinValue: 255, arrowImage: this.settings.clientFilesPath + 'rangearrows.gif'});
	...
	setAlpha: function(obj, alpha) {
       ...
       setColorFromHex: function(value)
       {
           if(value[0]=="#")
               value = value.substring(1);
           if (this.settings.startHex)
			this._cvp._hexInput.value = value;
		this._cvp.setValuesFromHex();
		this.positionMapAndSliderArrows();
		this.updateVisuals();
              this.updatePreview();
